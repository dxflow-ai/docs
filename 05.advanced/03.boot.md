...
**Subdomain format**: `ab1234567890.your-domain.com` (lowercase: 2 letters + 6–10 alphanumeric characters, 8–12 total), allocated under the hub's `proxy-domain`. The hub manages SSL for its nodes. Point each node at your hub with `bridge-gateway` — see [tunneling](/docs/advanced/tunneling).
