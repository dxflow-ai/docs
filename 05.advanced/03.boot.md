...
**Subdomain format**: `ab1234567890.your-domain.com` (lowercase: 2 letters + 1–10 alphanumeric characters, 3–12 total), allocated under the hub's `proxy-domain`. The hub manages SSL for its nodes. Point each node at your hub with `bridge-gateway` — see [tunneling](/docs/advanced/tunneling).
