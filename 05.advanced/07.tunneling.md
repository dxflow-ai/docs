...
`bridge-identity` becomes the node's subdomain and is required too: two letters followed by 6–10 alphanumerics (`^[a-z]{2}[a-z0-9]{6,10}$`).
...
| **invalid identity** | `bridge-identity` is unset or malformed. It must be two letters followed by 6–10 alphanumerics. |
