...
::card-group
  ...
  **Deployment Modes**: Configure engine boot options, network settings, and deployment scenarios
  ...
  ::card{title="Container Platforms" to="/docs/advanced/platforms" icon="i-hugeicons:codesandbox"}
  **Runtime Setup**: Configure Docker, Podman, Singularity, and Apptainer — including VM wrappers (OrbStack, Lima, WSL) on macOS and Windows
  ::
