...
`dxflow license create` opens your browser to dxflow Cloud with your Identity and name pre-filled, guides you through authentication, and generates the license file. Activating stores the license as `license-<identity>.json` (identity truncated to 8 chars) and updates the `license` config setting.
