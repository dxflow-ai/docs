...
| **RUNTIME** | Container Runtimes | Docker, Podman, Singularity, and Apptainer images, containers, and instances |
| **AGENT** | AI Agents | Agent session creation, prompting, and management |
