...
| `invalid identity …` | The identity is folded to letters and digits first, and the result must open with two letters — `2024-run` folds to `2024run`. See [Identities](/docs/advanced/concepts#identities). |
