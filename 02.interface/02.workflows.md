...
::callout
**Identity & remote source**: the console creates a workflow from an uploaded file. To set a custom identity, or to import a definition from a path, the [dxflow hub](https://github.com/dxflow-ai/hub) (`hub://<name>`), or a URL, use the CLI (`dxflow workflow create --identity <id> <source>`) or the API (`source` parameter).
::
