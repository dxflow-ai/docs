...
A running step in the [Workflows](/docs/interface/workflows) diagram adds a second kind of session: its **Shell** button opens a terminal inside that step's container, listed here alongside the host shells.
