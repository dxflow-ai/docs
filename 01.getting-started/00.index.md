...
dxflow is a single binary you run on any machine. It turns that machine into a node you can drive through a CLI, a REST API, or a web console, with a modular core that handles Docker Compose-style workflows, shell sessions, and file storage.
