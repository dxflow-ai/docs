...
::callout{color="blue"}
The console does the same thing: **Resources → New workflow** opens a dialog that searches this catalog and deploys an entry in one click, then start it from the node menu. Both clients call the same engine API. See the [User Interface documentation](/docs/interface).
::
